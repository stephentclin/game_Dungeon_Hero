...
func _draw() -> void:
	...
	if guardian_mode:
		# v10.36: remove the green guardian aura circle around the room-5 commander.
		pass
	else:
		draw_string(ThemeDB.fallback_font, Vector2(-42, -84), _loc("你的指挥台", "YOUR COMMAND POST"), HORIZONTAL_ALIGNMENT_LEFT, -1, 15, Color("#caffb7"))
